...
class DB(object):
    """
    DB class create an bridge between API and SQL Data base to perform CURD operation
    """
    ...
    def connect(self,database = None, max_retry=5):
        ...
        Args:
            database ([str], optional): The database to connect to. Envirolment mapped in config file.
